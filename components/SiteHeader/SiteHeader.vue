<template>
  <div class="site-header flex flex-row items-center py-6 sm:py-12 sm:mb-4">
    <nuxt-link class="text-white h-auto w-20 mr-8 sm:mr-16 hover:opacity-75 focus:opacity-75 mb-4 sm:mb-0" to="/">
    ...
    <ul class="text-xl text-green-400 flex flex-row flex-1 content-center pt-3 sm:pt-5">
      ...
      <li class="font-semibold mr-4 sm:mr-8"><nuxt-link to="/blog">Blog</nuxt-link></li>
      <li class="font-semibold"><nuxt-link to="/uses">Uses</nuxt-link></li>
    </ul>
  </div>
</template>
